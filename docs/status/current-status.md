...
- `pages/anchor-prompts.js` 的珍珠习惯页使用左下角悬浮珍珠蚌作为进度反馈；结果页点击“擦亮珍珠”后，悬浮窗中的珍珠上浮并显示旋转闪光线条。
...
- 珍珠视觉已从页面内容卡片中移到左下角悬浮窗；悬浮窗出现在珍珠习惯页和结果页，鼠标悬停或移动端按下时蚌壳会打开，结果页“擦亮珍珠”会触发珍珠上浮和旋转闪光效果。
